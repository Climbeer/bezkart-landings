...
const painPoints = [
  {
    title: "Гости забывают или теряют карты",
    text: "Человек хотел копить бонусы, но карта потерялась или осталась в другой куртке. Вместе с картой часто теряется и повод вернуться.",
    icon: (
  ...
  {
    title: "На кассе появляется лишний хаос",
    text: "Бариста проверяет штампы, клиент сомневается, очередь ждет. Лояльность начинает мешать обслуживанию вместо того, чтобы помогать.",
    icon: (
      <svg viewBox="0 0 48 48" className="h-10 w-10" fill="none" aria-hidden="true">
  ...
  {
    title: "Вы не понимаете, кто реально возвращается",
    text: "Карта вроде есть, а системы нет. Непонятно, кто стал постоянным, кто пропал и кого можно вернуть обратно.",
    icon: (
      <svg viewBox="0 0 48 48" className="h-10 w-10" fill="none" aria-hidden="true">
...
const steps = [
  ...
  {
    title: "Бонусы и визиты сохраняются в Telegram",
    text: "Они не теряются, не мнутся и не забываются в кармане или кошельке.",
  },
  {
    title: "Кофейня получает базу гостей",
    text: "Вы видите, кто возвращается, кто пропал и кому можно напомнить о себе.",
  },
  {
    title: "Лояльность начинает работать на повторы",
    text: "Не просто штампы ради штампов, а понятный инструмент возврата гостей.",
  },
];

const benefits = [
  "меньше хаоса на кассе",
  "гости не теряют бонусы вместе с картой",
  "у вас появляется база клиентов",
  "вы начинаете видеть, кто возвращается",
  "можно возвращать “пропавших” гостей",
  "остается та же привычная механика, но без бумаги и путаницы",
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Нет. Все работает через Telegram.",
  },
  {
    question: "А если гости привыкли к бумажным картам?",
    answer: "Для них логика почти не меняется. Они так же копят бонусы, только теперь ничего не теряется и не путается.",
  },
  {
    question: "Что это дает кроме замены бумаги?",
    answer: "Вы начинаете видеть базу гостей и понимать, кто возвращается, а кто пропал. Это уже не просто карточка, а более управляемая лояльность.",
  },
  {
    question: "Это не замедлит работу бариста?",
    answer: "Наоборот. Такая механика нужна, чтобы убрать лишние спорные и неудобные моменты на кассе.",
  },
];
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
            <div className="max-w-2xl">
              ...
              <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-[-0.03em] text-white sm:text-5xl lg:text-6xl">
                Замените бумажные карты лояльности на Telegram — без сложного внедрения и без хаоса на кассе
              </h1>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#e3e7ff] sm:text-xl">
                Если гости теряют карты, бариста путается в штампах, а вы не понимаете, кто возвращается, а кто пропал
                — переведите привычную механику лояльности в Telegram и управляйте повторными визитами нормально.
              </p>
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/75 bg-white/80 p-5 shadow-[0_30px_80px_rgba(88,58,34,0.12)] backdrop-blur sm:p-6">
                <div className="grid gap-4 sm:grid-cols-[0.88fr_1.12fr]">
                  <div className="rounded-[1.5rem] border border-[#f0e2d6] bg-[#fffaf5] p-4">
                    ...
                    <h2 className="mt-2 text-2xl font-semibold text-[#3a2a20]">Бумажная карта</h2>
                    ...
                    <ul className="mt-4 space-y-2 text-sm text-[#7a6658]">
                      <li>Карта может потеряться</li>
                      <li>На кассе возникают споры</li>
                      <li>Владелец не видит базу гостей</li>
                      <li>Нельзя напомнить о себе клиенту</li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-[1.5rem] bg-[linear-gradient(180deg,_#2d2f85_0%,_#23245e_100%)] p-4 text-[#fff7f0]">
                    ...
                    <div className="mt-3 rounded-[1.6rem] bg-[rgba(255,255,255,0.12)] p-4 text-white shadow-inner">
                      ...
                      <div className="mt-4 grid gap-2 text-sm text-white/90">
                        <div className="rounded-2xl bg-white/10 px-3 py-2">Гость подключается по QR и видит бонусы в телефоне</div>
                        <div className="rounded-2xl bg-white/10 px-3 py-2">Бонусы не теряются и не вызывают споры на кассе</div>
                        <div className="rounded-2xl bg-white/10 px-3 py-2">У точки появляется прозрачная история повторных визитов</div>
                      </div>
                    </div>

                    <div className="mt-4 rounded-[1.25rem] border border-white/10 bg-white/10 px-4 py-3 text-sm text-white/85">
                      Та же механика для гостя. Намного меньше путаницы для точки.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 max-w-2xl">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-4xl">
              Почему бумажная лояльность перестает работать
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-[linear-gradient(180deg,_#fffaf5_0%,_#f7eee5_100%)] p-6 shadow-[0_22px_70px_rgba(88,58,34,0.08)] sm:p-8 lg:p-10">
          <div className="max-w-2xl">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-[#2f241d] sm:text-4xl">
              Как работает Telegram-лояльность для кофейни
            </h2>
          </div>
      ...
      <section className="px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[2rem] bg-[linear-gradient(135deg,_#2d2f85_0%,_#23245e_100%)] p-7 text-[#fff7f0] shadow-[0_24px_80px_rgba(18,27,92,0.2)] sm:p-8">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] sm:text-4xl">
              Что меняется после перехода с бумаги
            </h2>
            <p className="mt-5 text-lg leading-8 text-[#f3e6db]">
              В итоге у вас не просто “каждый шестой кофе в подарок”, а понятная и управляемая система лояльности,
              которая помогает возвращать гостей и не тормозит работу точки.
            </p>
          </div>
