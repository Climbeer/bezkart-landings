...
const painPoints = [
  {
    title: "Акции проходят мимо постоянных гостей",
    text: "Вы готовите предложение, но большая часть гостей просто не узнает о нем после покупки и уходит без повода вернуться.",
    icon: (
  ...
  {
    title: "Нет прямого канала связи с клиентами",
    text: "Если у кофейни нет своей базы, то рассказать про новинку, акцию или тихие часы просто некому и некуда.",
    icon: (
      <svg viewBox="0 0 48 48" className="h-10 w-10" fill="none" aria-hidden="true">
...
const steps = [
  ...
  {
    title: "База гостей появляется в Telegram",
    text: "После подключения у кофейни появляется свой понятный канал связи с гостями без отдельного приложения.",
  },
  {
    title: "Вы можете напоминать о себе",
    text: "Становится проще доносить до гостей акции, новинки и поводы зайти снова, а не ждать случайного возвращения.",
  },
  {
    title: "Акции и предложения доходят до гостей",
    text: "Лояльность начинает работать не только на бонусы, но и как реальный канал коммуникации после покупки.",
  },
];

const benefits = [
  "у вас появляется база гостей",
  "можно сообщать про акции и новинки",
  "можно возвращать гостей в тихие часы",
  "маркетинг перестаёт быть случайным",
  "лояльность начинает работать как канал коммуникации",
  "гости не забывают о вашей точке",
];

const faqs = [
  {
    question: "Как гости будут узнавать про акции?",
    answer: "Через Telegram. БезКарт помогает не терять контакт с гостями после покупки и доносить до них акции, новинки и поводы вернуться.",
  },
  {
    question: "Нужен ли отдельный маркетолог?",
    answer: "Нет. Идея в том, чтобы у кофейни появился простой рабочий канал коммуникации без отдельной сложной команды.",
  },
  {
    question: "Сложно ли собирать базу?",
    answer: "Нет. Гость просто подключается по QR-коду, и база начинает собираться через привычный Telegram-сценарий.",
  },
  {
    question: "Нужно ли приложение?",
    answer: "Нет. Все работает через Telegram, поэтому и кофейне, и гостю не нужно внедрять отдельное приложение.",
  },
  {
    question: "Подходит ли для coffee-to-go формата?",
    answer: "Да. Такой формат особенно удобен там, где важны быстрые повторные визиты и нужно регулярно напоминать о себе без сложной механики.",
  },
  {
    question: "Что это дает кроме бонусов?",
    answer: "Лояльность начинает работать как канал коммуникации: можно рассказывать про предложения, новинки и регулярно возвращать гостей в точку.",
  },
];
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#e3e7ff] sm:text-xl">
                БезКарт помогает не только с бонусами, но и с прямой связью с гостями через Telegram, чтобы
                рассказывать про акции, новинки и возвращать людей без случайной надежды на сторис и поток.
              </p>
                ...
                <div className="grid gap-4 sm:grid-cols-[0.88fr_1.12fr]">
                  <div className="rounded-[1.5rem] border border-[#f0e2d6] bg-[#fffaf5] p-4">
                    ...
                    <ul className="mt-4 space-y-2 text-sm text-[#7a6658]">
                      <li>Акции и новинки проходят мимо гостей</li>
                      <li>Нет своей базы и прямого канала связи</li>
                      <li>Нельзя быстро сообщить о предложении</li>
                      <li>Маркетинг держится на потоке, сторис и надежде</li>
                    </ul>
                  </div>
                    ...
                    <div className="mt-3 rounded-[1.6rem] bg-[rgba(255,255,255,0.12)] p-4 text-white shadow-inner">
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">Реальный экран бота для связи с гостями</p>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 grid gap-2 text-sm text-white/90">
                        <div className="rounded-2xl bg-white/10 px-3 py-2">База гостей собирается в Telegram</div>
                        <div className="rounded-2xl bg-white/10 px-3 py-2">Можно напоминать о себе и доносить акции</div>
                        <div className="rounded-2xl bg-white/10 px-3 py-2">Коммуникация становится управляемой, а не случайной</div>
                      </div>
                    </div>

                    <div className="mt-4 rounded-[1.25rem] border border-white/10 bg-white/10 px-4 py-3 text-sm text-white/85">
                      Та же простая механика для гостя. Намного больше возможностей напоминать о себе.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 max-w-2xl">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-white sm:text-4xl">
              Почему акции и поводы вернуться не доходят до гостей
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-[linear-gradient(180deg,_#fffaf5_0%,_#f7eee5_100%)] p-6 shadow-[0_22px_70px_rgba(88,58,34,0.08)] sm:p-8 lg:p-10">
          <div className="max-w-2xl">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-[#2f241d] sm:text-4xl">
              Как БезКарт помогает держать связь с гостями
            </h2>
          </div>
            ...
            <div className="grid items-center gap-5 md:grid-cols-[1.1fr_0.9fr]">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-semibold tracking-[-0.03em] text-[#2f241d]">
                  Не абстрактная схема, а живой экран бота для связи с гостями
                </h3>
                <p className="mt-3 text-base leading-7 text-[#5d4c3f]">
                  Ниже реальный экран БезКарт для точки. Он показывает, что база гостей и коммуникация после покупки
                  могут быть понятной частью ежедневной работы, а не случайной активностью от случая к случаю.
                </p>
              </div>
      ...
      <section className="px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[2rem] bg-[linear-gradient(135deg,_#2d2f85_0%,_#23245e_100%)] p-7 text-[#fff7f0] shadow-[0_24px_80px_rgba(18,27,92,0.2)] sm:p-8">
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] sm:text-4xl">
              Что меняется, когда у кофейни появляется канал связи
            </h2>
            <p className="mt-5 text-lg leading-8 text-[#f3e6db]">
              В итоге у вас не просто бонусная механика, а понятная система, через которую можно регулярно напоминать
              о себе, доносить предложения и возвращать гостей в нужный момент.
            </p>
          </div>
